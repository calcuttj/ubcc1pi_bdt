...
Event::Event(const EventPeLEE& eventPeLEE, const bool excludeGranddaughterParticles /*= false*/)
{
    ...
    //std::cout << "Event.cxx, reco particles size " << nRecoParticles << std::endl; 
    ...
    //std::cout << "Event.cxx, reco particles to skip size " << nRecoParticlesToSkip << std::endl;
	...
	if(!(pParticlePeLEE->backtracked_purity.IsSet())) pParticle->backtrackedPurity.Set(-9999.f);
	else if(pParticlePeLEE->backtracked_purity() != floatMinValue) pParticle->backtrackedPurity.Set(pParticlePeLEE->backtracked_purity());
	//else pParticle->backtrackedPurity.Set(-9999.f);
	
	if (!(pParticlePeLEE->backtracked_completeness.IsSet())) pParticle->backtrackedCompleteness.Set(-9999.f);
	else if(pParticlePeLEE->backtracked_completeness() != floatMinValue) pParticle->backtrackedCompleteness.Set(pParticlePeLEE->backtracked_completeness());
        else pParticle->backtrackedCompleteness.Set(-9999.f);
	
	if (!(pParticlePeLEE->backtracked_pdg.IsSet())) pParticle->backtrackedPDG.Set(-9999.f); 
	else if(pParticlePeLEE->backtracked_pdg() != floatMinValue) pParticle->backtrackedPDG.Set(std::abs(pParticlePeLEE->backtracked_pdg()));
	else pParticle->backtrackedPDG.Set(-9999.f);
	
	if (!(pParticlePeLEE->backtracked_px.IsSet())) pParticle->backtrackedMomentum.Set(-9999.f);
	else if( (pParticlePeLEE->backtracked_px() != floatMinValue) && (pParticlePeLEE->backtracked_py() != floatMinValue) && (pParticlePeLEE->backtracked_pz() != floatMinValue) ) pParticle->backtrackedMomentum.Set( std::sqrt( std::pow(pParticlePeLEE->backtracked_px(), 2) + std::pow(pParticlePeLEE->backtracked_py(), 2) + std::pow(pParticlePeLEE->backtracked_pz(), 2) ) );
        else pParticle->backtrackedMomentum.Set(-9999.f);
	...
	//else pParticle->pdgCode.Set(-9999);
